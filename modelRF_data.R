# Disclaimer:
# 1. This code is intended for academic research and discussion purposes only. The content and methods in this code do not constitute any form of commercial use or recommendation.
# 2. The intermediate data and results generated by running this code are for academic discussion and testing purposes only. The results do not represent the accuracy or reliability of the actual application.
# 3. The author of this code does not take responsibility for the accuracy, completeness, or any consequences arising from the use of the code.
# 4. The author is not responsible for any issues or consequences arising from the data, results, or their application generated by running this code.
# 5. This code may be modified or updated at any time, and the specific results and impacts may vary accordingly. Users are responsible for any consequences arising from the use of this code, including but not limited to data loss, incorrect analysis, or other unexpected outcomes.
# 6. Users should evaluate the accuracy and applicability of the results on their own. If the code is to be used for actual decision-making or other applications, it is recommended to conduct thorough validation.
...
# inhabited area extraction at 0.05бу
...
# inhabited area extraction at 0.01бу
...
# inhabited area extraction at 0.005бу
...
for (i in 1:length(normalized_rasters_0.05)) {
  ...
  cat(paste0(raster_name, " б· ",i," of ", length(normalized_rasters_0.05), " has processed successfully!\n"))
}
...
for (i in 1:length(normalized_rasters_0.01)) {
  ...
  cat(paste0(raster_name, " б· ",i," of ", length(normalized_rasters_0.01), " has processed successfully!\n"))
}
...
for (i in 1:length(normalized_rasters_0.005)) {
  ...
  cat(paste0(raster_name, " б· ",i," of ", length(normalized_rasters_0.005), " has processed successfully!\n"))
}
